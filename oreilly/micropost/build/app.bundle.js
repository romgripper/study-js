...
function getPosts() {
    _http.http.get("http://localhost:3000/posts").then(function (posts) {
        POSTS = posts;
        _ui.ui.showPosts(POSTS);
    }).catch(console.log);
}
...
function postsClicked(e) {
    ...
    if (classList.contains("edit")) {
        ...
        _ui.ui.fillForm(post);
    } else if (classList.contains("delete")) {
        var _id = e.target.parentElement.dataset.id;
        _http.http.delete("http://localhost:3000/posts/" + _id).then(function () {
...
function cancelEdit(e) {
    if (e.target.classList.contains("post-cancel")) _ui.ui.changeFormState("add");
